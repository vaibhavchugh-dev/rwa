                  ...
                  <div className="form-group">
                    ...
                    <div className="form-control-wrap">
                      <input
                        ...
                        className="form-control"
                      />
                      {errors.prevPrice && <span className="invalid">{errors.title.message}</span>}
                    </div>
                  </div>
                </Col>
                <Col md="6">
                  <div className="form-group">
                    ...
                    <div className="form-control-wrap">
                      <input
                        ...
                        className="form-control"
                      />
                      {errors.newPrice && <span className="invalid">{errors.title.message}</span>}
                    </div>
                  </div>
                </Col>
                <Col md="6">
                  <div className="form-group">
                    ...
                    <div className="form-control-wrap">
                      <input
                        ...
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.type && <span className="invalid">{errors.title.message}</span>}
                    </div>
                  </div>
                </Col>
                <Col size="12">
